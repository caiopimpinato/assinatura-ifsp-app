...
def gerar_assinatura():
    ...
    draw.text((313, 84), funcao_final, font=fonte_ajustada(draw, funcao_final, 330, 26, 20), fill=verde)
    draw.text((313, 119), setor_final, font=fonte_ajustada(draw, setor_final, 350, 22, 17), fill=cinza)
    draw.line((307, 150, 522, 150), fill=amarelo, width=2)

    draw.text((352, 166), email_final, font=fonte_ajustada(draw, email_final, 365, 16, 12), fill=cinza)
    draw.text((352, 211), telefone_final, font=fonte_ajustada(draw, telefone_final, 315, 16, 12), fill=cinza)
    draw.text((352, 253), site_final, font=fonte_ajustada(draw, site_final, 315, 16, 12), fill=cinza)
